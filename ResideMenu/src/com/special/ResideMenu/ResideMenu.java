...
public class ResideMenu extends FrameLayout {
  ...
  @Override protected boolean fitSystemWindows(Rect insets) {
    ...
    this.setPadding(viewActivity.getPaddingLeft() + insets.left,
        viewActivity.getPaddingTop() + insets.top, viewActivity.getPaddingRight() + insets.right,
        bottomPadding);
   ...
   */
  @Deprecated public void addMenuItem(ResideMenuItem menuItem) {
   ...
   * WARNING: It will be removed from v2.0.
   */
  @Deprecated public void setMenuItems(List<ResideMenuItem> menuItems) {
   ...
   * WARNING: It will be removed from v2.0.
   */
  @Deprecated public List<ResideMenuItem> getMenuItems() {
  ...
  public void openMenu(int direction) {
    ...
    AnimatorSet scaleDown_shadow =
        buildScaleDownAnimation(imageViewShadow, mScaleValue + shadowAdjustScaleX,
  ...
  @Deprecated public void setDirectionDisable(int direction) {
